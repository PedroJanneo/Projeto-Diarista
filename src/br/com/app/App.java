...
import br.com.classes.Diarista;
	...
	public class App {
		...
		public static void main(String[] args) {
			...
			System.out.println("Digite o valo do saque: ");
			cliente.sacar(campo.nextDouble());
			...
			System.out.println("O deposito é de: " + cliente.getSaldo());
	 		System.out.println("Quanto deseja sacar: " + cliente.getSaldo());
